...
export const dailyBriefings = mysqlTable(
  "daily_briefings",
  {
    ...
    farmerId: bigint("farmer_id", { mode: "number", unsigned: true })
      .notNull()
      .references(() => farmers.id),
    scheduledAt: timestamp("scheduled_at").notNull(), // 8:00 AM
    ...
    generatedMessage: text("generated_message"), // final card message
    weatherData: json("weather_data"), // snapshot of weather
    marketData: json("market_data"), // snapshot of prices
    schemesReferenced: json("schemes_referenced"), // list of scheme IDs
    cropTipData: json("crop_tip_data"), // snapshot of tip
